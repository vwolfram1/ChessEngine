"""
Constants, piece-square tables (tapered), and precomputed data.
All PST values are from PeSTO, tuned via Texel's method.
"""

import chess

# ---------------------------------------------------------------------------
# Centipawn piece values (midgame / endgame)
# ---------------------------------------------------------------------------
MG_VALUE = {
    chess.PAWN:   82,
    chess.KNIGHT: 337,
...
MAX_PHASE = 24  # 4×knight + 4×bishop + 4×rook + 2×queen

# Search constants
INF          = 100_000
MATE_SCORE   = 99_000
MATE_LOWER   = MATE_SCORE - 1000
MAX_PLY      = 128
MAX_KILLER   = 2
NULL_MOVE_R  = 3       # base null-move reduction
LMR_FULL_DEPTH_MOVES = 4
LMR_REDUCTION_LIMIT  = 3
FUTILITY_MARGINS     = [0, 200, 300, 500]   # indexed by depth
DELTA_PRUNE_MARGIN   = 200                  # qsearch delta pruning

# Piece values for MVV-LVA (captures ordering)
MVV_LVA_SCORES = {
    chess.PAWN:   100,
    chess.KNIGHT: 200,
    chess.BISHOP: 200,
...
# LMR table: reductions[depth][move_number]
import math
